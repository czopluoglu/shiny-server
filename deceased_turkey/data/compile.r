...
# After installing Docker and opening RStudio,
# run the following two commands from RStudio Terminal
...
#setwd("C:/Users/Dr Zopluoglu/Desktop/shiny-server/turkey-death-statistics")


rr <- c()

for(xx in 1:length(tables)){
  rr[xx]=nrow(tables[[xx]][[1]])
}
